...
5. "TipoDado" é o tipo dos dados existentes na coluna, sendo classificado como: Texto, Número
inteiro, Verdadeiro/Falso, Data, Número Decimal.;

6. "Aceitar nulo" determina se esta coluna não possuir informações se o registro pode ser aceito ou
não.;
